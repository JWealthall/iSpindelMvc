...
namespace iSpindelMvc.Data
{
    ...
    public class LogDb
    {
        ...
        public Batch BatchGet(Guid batchId)
        {
            return _context.Batches.FindAsync(batchId).Result;
        }
        ...
        public Device DeviceGet(Guid deviceId)
        {
            return _context.Devices.FindAsync(deviceId).Result;
        }
        ...
        public SummaryDataModel SummaryData(Guid? deviceId = null, bool devicesOnly = false, bool batchesOnly = false, bool current = false)
        {
            ...
            if (!devicesOnly) data.Batches = BatchSummaryList(deviceId, current: current).Result;
            return data;
        }
