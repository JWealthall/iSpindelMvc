...
This is a basic service for recording information from an *iSpindel* written using asp.net core and entity framework.
...
This is basic asp.net, but I'll get this rewritten using Angular and React for the front end.
